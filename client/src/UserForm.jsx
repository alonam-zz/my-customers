...
import { EMPLOYEE_ROLES } from "./utils/constans.js";
 ...
 */
export default function UserForm({ initialUser = {}, onSubmitForm, onCloseForm }) {
  const { t } = useI18n();
    ...
    <form className="container p-3" onSubmit={handleSubmit}>
      <div className="row g-3">
        ...
        <div className="col-12 col-md-6">
          ...
          <label className="form-label">{initialUser.username}</label>
          <input className="form-control" name="username" value={form.username} onChange={form.id?{}:handleChange} disabled={form.id?true:false} required/>
        </div>
        <div className="col-12 col-md-6">
